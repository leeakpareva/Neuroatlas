/**
 * NAVADA KneeAtlas — interactive segmented human knee joint.
 *
 * A static-anatomy organ page (no telemetry/scenarios — a knee doesn't cycle).
...
const VAULT_IDS = new Set(['Femur', 'Tibia', 'Fibula', 'Patella']);
...
class NavadaKnee {
    ...
    async init() {
        try {
            ...
            this.animate();
            console.log('NAVADA KneeAtlas ready —', this.meshes.length, 'meshes /', this.idToMeshes.size, 'parts');
        } catch (err) {
            console.error(err);
...
document.addEventListener('DOMContentLoaded', () => {
    const app = new NavadaKnee();
    app.init();
    window.navadaKnee = app;
});
