/**
 * NAVADA LarynxAtlas — interactive segmented human larynx.
 *
 * A static-anatomy organ page (no telemetry/scenarios — a larynx doesn't cycle).
...
const VAULT_IDS = new Set(['Thyroid cartilage']);
...
class NavadaLarynx {
    ...
    async init() {
        try {
            ...
            this.animate();
            console.log('NAVADA LarynxAtlas ready —', this.meshes.length, 'meshes /', this.idToMeshes.size, 'parts');
        } catch (err) {
            console.error(err);
...
document.addEventListener('DOMContentLoaded', () => {
    const app = new NavadaLarynx();
    app.init();
    window.navadaLarynx = app;
});
